...
iteration_statement 
	: WHILE '(' expression ')' statement                                                                   	{ LOG("iteration_statement:" <<"WHILE("<< $<_t_string>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"expression("<< $<_t_expression>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<"statement("<< $<_t_statement>5 <<")" <<")") CAst::iteration_statement_3 *obj=new CAst::iteration_statement_3(	$<_t_expression>3,$<_t_statement>5 ); LOG("Created iteration_statement_3: "<<obj)$<_t_iteration_statement>$=obj; LOG("Returning :"<<$<_t_iteration_statement>$) 	}
	...
	| FOR '(' expression_statement expression_statement ')' statement                                      	{ LOG("iteration_statement:" <<"FOR("<< $<_t_string>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"expression_statement("<< $<_t_expression_statement>3 <<")" <<"expression_statement("<< $<_t_expression_statement>4 <<")" <<"')'("<< $<_t_string>5 <<")" <<"statement("<< $<_t_statement>6 <<")" <<")") CAst::iteration_statement_2 *obj=new CAst::iteration_statement_2(	$<_t_expression_statement>3,$<_t_expression_statement>4,NULL,$<_t_statement>6 ); LOG("Created iteration_statement_2: "<<obj)$<_t_iteration_statement>$=obj; LOG("Returning :"<<$<_t_iteration_statement>$) 	}
	| FOR '(' expression_statement expression_statement expression ')' statement                           	{ LOG("iteration_statement:" <<"FOR("<< $<_t_string>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"expression_statement("<< $<_t_expression_statement>3 <<")" <<"expression_statement("<< $<_t_expression_statement>4 <<")" <<"expression("<< $<_t_expression>5 <<")" <<"')'("<< $<_t_string>6 <<")" <<"statement("<< $<_t_statement>7 <<")" <<")") CAst::iteration_statement_2 *obj=new CAst::iteration_statement_2(	$<_t_expression_statement>3,$<_t_expression_statement>4,$<_t_expression>5,$<_t_statement>7 ); LOG("Created iteration_statement_2: "<<obj)$<_t_iteration_statement>$=obj; LOG("Returning :"<<$<_t_iteration_statement>$) 	}
	;
...
pointer 
	...
	| '*' pointer                                                                                          	{ LOG("pointer:" <<"'*'("<< $<_t_string>1 <<")" <<"pointer("<< $<_t_pointer>2 <<")" <<")") CAst::pointer_item_2 *obj=new CAst::pointer_item_2(	 ); LOG("Created pointer_item_2: "<<obj)$<_t_pointer>2 ->append(obj);$<_t_pointer>$=$<_t_pointer>2; LOG("Appended to pointer") LOG("Returning :"<<$<_t_pointer>$) 	}
...
statement 
	: labeled_statement                                                                                    	{ LOG("statement:" <<"labeled_statement("<< $<_t_labeled_statement>1 <<")" <<")") CAst::statement_6 *obj=new CAst::statement_6(	$<_t_labeled_statement>1 ); LOG("Created statement_6: "<<obj)$<_t_statement>$=obj; LOG("Returning :"<<$<_t_statement>$) 	}
	| compound_statement                                                                                   	{ LOG("statement:" <<"compound_statement("<< $<_t_compound_statement>1 <<")" <<")") CAst::statement_1 *obj=new CAst::statement_1(	$<_t_compound_statement>1 ); LOG("Created statement_1: "<<obj)$<_t_statement>$=obj; LOG("Returning :"<<$<_t_statement>$) 	}
	| expression_statement                                                                                 	{ LOG("statement:" <<"expression_statement("<< $<_t_expression_statement>1 <<")" <<")") CAst::statement_2 *obj=new CAst::statement_2(	$<_t_expression_statement>1 ); LOG("Created statement_2: "<<obj)$<_t_statement>$=obj; LOG("Returning :"<<$<_t_statement>$) 	}
	| selection_statement                                                                                  	{ LOG("statement:" <<"selection_statement("<< $<_t_selection_statement>1 <<")" <<")") CAst::statement_3 *obj=new CAst::statement_3(	$<_t_selection_statement>1 ); LOG("Created statement_3: "<<obj)$<_t_statement>$=obj; LOG("Returning :"<<$<_t_statement>$) 	}
	| iteration_statement                                                                                  	{ LOG("statement:" <<"iteration_statement("<< $<_t_iteration_statement>1 <<")" <<")") CAst::statement_4 *obj=new CAst::statement_4(	$<_t_iteration_statement>1 ); LOG("Created statement_4: "<<obj)$<_t_statement>$=obj; LOG("Returning :"<<$<_t_statement>$) 	}
	| jump_statement                                                                                       	{ LOG("statement:" <<"jump_statement("<< $<_t_jump_statement>1 <<")" <<")") CAst::statement_5 *obj=new CAst::statement_5(	$<_t_jump_statement>1 ); LOG("Created statement_5: "<<obj)$<_t_statement>$=obj; LOG("Returning :"<<$<_t_statement>$) 	}
	;
...
direct_abstract_declarator 
	...
	| '[' constant_expression ']'                                                                          	{ LOG("direct_abstract_declarator:" <<"'['("<< $<_t_string>1 <<")" <<"constant_expression("<< $<_t_constant_expression>2 <<")" <<"']'("<< $<_t_string>3 <<")" <<")") CAst::direct_abstract_declarator_2 *obj=new CAst::direct_abstract_declarator_2(	NULL,$<_t_constant_expression>2 ); LOG("Created direct_abstract_declarator_2: "<<obj)$<_t_direct_abstract_declarator>$=obj; LOG("Returning :"<<$<_t_direct_abstract_declarator>$) 	}
	...
	| direct_abstract_declarator '[' constant_expression ']'                                               	{ LOG("direct_abstract_declarator:" <<"direct_abstract_declarator("<< $<_t_direct_abstract_declarator>1 <<")" <<"'['("<< $<_t_string>2 <<")" <<"constant_expression("<< $<_t_constant_expression>3 <<")" <<"']'("<< $<_t_string>4 <<")" <<")") CAst::direct_abstract_declarator_2 *obj=new CAst::direct_abstract_declarator_2(	$<_t_direct_abstract_declarator>1,$<_t_constant_expression>3 ); LOG("Created direct_abstract_declarator_2: "<<obj)$<_t_direct_abstract_declarator>$=obj; LOG("Returning :"<<$<_t_direct_abstract_declarator>$) 	}
...
declaration_specifiers 
	...
	| type_qualifier declaration_specifiers                                                                	{ LOG("declaration_specifiers:" <<"type_qualifier("<< $<_t_type_qualifier>1 <<")" <<"declaration_specifiers("<< $<_t_declaration_specifiers>2 <<")" <<")") CAst::declaration_specifiers_item_1 *obj=new CAst::declaration_specifiers_item_1(	$<_t_type_qualifier>1 ); LOG("Created declaration_specifiers_item_1: "<<obj)$<_t_declaration_specifiers>2 ->append(obj);$<_t_declaration_specifiers>$=$<_t_declaration_specifiers>2; LOG("Appended to declaration_specifiers") LOG("Returning :"<<$<_t_declaration_specifiers>$) 	}
	;
...
direct_declarator 
	...
	| direct_declarator '[' constant_expression ']'                                                        	{ LOG("direct_declarator:" <<"direct_declarator("<< $<_t_direct_declarator>1 <<")" <<"'['("<< $<_t_string>2 <<")" <<"constant_expression("<< $<_t_constant_expression>3 <<")" <<"']'("<< $<_t_string>4 <<")" <<")") CAst::direct_declarator_5 *obj=new CAst::direct_declarator_5(	$<_t_direct_declarator>1,$<_t_constant_expression>3 ); LOG("Created direct_declarator_5: "<<obj)$<_t_direct_declarator>$=obj; LOG("Returning :"<<$<_t_direct_declarator>$) 	}
	...
	| direct_declarator '(' parameter_type_list ')'                                                        	{ LOG("direct_declarator:" <<"direct_declarator("<< $<_t_direct_declarator>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"parameter_type_list("<< $<_t_parameter_type_list>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<")") CAst::direct_declarator_1 *obj=new CAst::direct_declarator_1(	$<_t_direct_declarator>1,$<_t_parameter_type_list>3 ); LOG("Created direct_declarator_1: "<<obj)$<_t_direct_declarator>$=obj; LOG("Returning :"<<$<_t_direct_declarator>$) 	}
