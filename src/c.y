...
unary_expression 
	: postfix_expression                                                                                   	{ LOG("unary_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<")") CAst::unary_expression_4 *obj=new CAst::unary_expression_4(	$<_t_postfix_expression>1 ); LOG("Created unary_expression_4: "<<obj)$<_t_unary_expression>$=obj; LOG("Returning :"<<$<_t_unary_expression>$) 	}
	...
	| unary_operator cast_expression                                                                       	{ LOG("unary_expression:" <<"unary_operator("<< $<_t_unary_operator>1 <<")" <<"cast_expression("<< $<_t_cast_expression>2 <<")" <<")") CAst::unary_expression_2 *obj=new CAst::unary_expression_2(	$<_t_unary_operator>1,$<_t_cast_expression>2 ); LOG("Created unary_expression_2: "<<obj)$<_t_unary_expression>$=obj; LOG("Returning :"<<$<_t_unary_expression>$) 	}
	...
	| SIZEOF '(' type_name ')'                                                                             	{ LOG("unary_expression:" <<"SIZEOF("<< $<_t_string>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"type_name("<< $<_t_type_name>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<")") CAst::unary_expression_1 *obj=new CAst::unary_expression_1(	$<_t_type_name>3 ); LOG("Created unary_expression_1: "<<obj)$<_t_unary_expression>$=obj; LOG("Returning :"<<$<_t_unary_expression>$) 	}
	;
...
initializer 
	: assignment_expression                                                                                	{ LOG("initializer:" <<"assignment_expression("<< $<_t_assignment_expression>1 <<")" <<")") CAst::initializer_2 *obj=new CAst::initializer_2(	$<_t_assignment_expression>1 ); LOG("Created initializer_2: "<<obj)$<_t_initializer>$=obj; LOG("Returning :"<<$<_t_initializer>$) 	}
	| '{' initializer_list '}'                                                                             	{ LOG("initializer:" <<"'{'("<< $<_t_string>1 <<")" <<"initializer_list("<< $<_t_initializer_list>2 <<")" <<"'}'("<< $<_t_string>3 <<")" <<")") CAst::initializer_1 *obj=new CAst::initializer_1(	$<_t_initializer_list>2,NULL ); LOG("Created initializer_1: "<<obj)$<_t_initializer>$=obj; LOG("Returning :"<<$<_t_initializer>$) 	}
	| '{' initializer_list ',' '}'                                                                         	{ LOG("initializer:" <<"'{'("<< $<_t_string>1 <<")" <<"initializer_list("<< $<_t_initializer_list>2 <<")" <<"','("<< $<_t_string>3 <<")" <<"'}'("<< $<_t_string>4 <<")" <<")") CAst::initializer_1 *obj=new CAst::initializer_1(	$<_t_initializer_list>2,new CAst::token($<_t_string>3) ); LOG("Created initializer_1: "<<obj)$<_t_initializer>$=obj; LOG("Returning :"<<$<_t_initializer>$) 	}
	;
...
iteration_statement 
	...
	| DO statement WHILE '(' expression ')' ';'                                                            	{ LOG("iteration_statement:" <<"DO("<< $<_t_string>1 <<")" <<"statement("<< $<_t_statement>2 <<")" <<"WHILE("<< $<_t_string>3 <<")" <<"'('("<< $<_t_string>4 <<")" <<"expression("<< $<_t_expression>5 <<")" <<"')'("<< $<_t_string>6 <<")" <<"';'("<< $<_t_string>7 <<")" <<")") CAst::iteration_statement_1 *obj=new CAst::iteration_statement_1(	$<_t_statement>2,$<_t_expression>5 ); LOG("Created iteration_statement_1: "<<obj)$<_t_iteration_statement>$=obj; LOG("Returning :"<<$<_t_iteration_statement>$) 	}
...
type_specifier 
	: VOID                                                                                                 	{ LOG("type_specifier:" <<"VOID("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_3 *obj=new CAst::type_specifier_3(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_3: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| CHAR                                                                                                 	{ LOG("type_specifier:" <<"CHAR("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_3 *obj=new CAst::type_specifier_3(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_3: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| SHORT                                                                                                	{ LOG("type_specifier:" <<"SHORT("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_3 *obj=new CAst::type_specifier_3(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_3: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| INT                                                                                                  	{ LOG("type_specifier:" <<"INT("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_3 *obj=new CAst::type_specifier_3(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_3: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| LONG                                                                                                 	{ LOG("type_specifier:" <<"LONG("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_3 *obj=new CAst::type_specifier_3(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_3: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| FLOAT                                                                                                	{ LOG("type_specifier:" <<"FLOAT("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_3 *obj=new CAst::type_specifier_3(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_3: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| DOUBLE                                                                                               	{ LOG("type_specifier:" <<"DOUBLE("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_3 *obj=new CAst::type_specifier_3(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_3: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| SIGNED                                                                                               	{ LOG("type_specifier:" <<"SIGNED("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_3 *obj=new CAst::type_specifier_3(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_3: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| UNSIGNED                                                                                             	{ LOG("type_specifier:" <<"UNSIGNED("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_3 *obj=new CAst::type_specifier_3(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_3: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| struct_or_union_specifier                                                                            	{ LOG("type_specifier:" <<"struct_or_union_specifier("<< $<_t_struct_or_union_specifier>1 <<")" <<")") CAst::type_specifier_1 *obj=new CAst::type_specifier_1(	$<_t_struct_or_union_specifier>1 ); LOG("Created type_specifier_1: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| enum_specifier                                                                                       	{ LOG("type_specifier:" <<"enum_specifier("<< $<_t_enum_specifier>1 <<")" <<")") CAst::type_specifier_2 *obj=new CAst::type_specifier_2(	$<_t_enum_specifier>1 ); LOG("Created type_specifier_2: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	;
...
postfix_expression 
	...
	| postfix_expression '[' expression ']'                                                                	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"'['("<< $<_t_string>2 <<")" <<"expression("<< $<_t_expression>3 <<")" <<"']'("<< $<_t_string>4 <<")" <<")") CAst::postfix_expression_1 *obj=new CAst::postfix_expression_1(	$<_t_postfix_expression>1,$<_t_expression>3 ); LOG("Created postfix_expression_1: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression '(' ')'                                                                           	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"')'("<< $<_t_string>3 <<")" <<")") CAst::postfix_expression_4 *obj=new CAst::postfix_expression_4(	$<_t_postfix_expression>1,new CAst::token($<_t_string>2),NULL ); LOG("Created postfix_expression_4: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression '(' argument_expression_list ')'                                                  	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"argument_expression_list("<< $<_t_argument_expression_list>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<")") CAst::postfix_expression_4 *obj=new CAst::postfix_expression_4(	$<_t_postfix_expression>1,new CAst::token($<_t_string>2),$<_t_argument_expression_list>3 ); LOG("Created postfix_expression_4: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression '.' IDENTIFIER                                                                    	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"'.'("<< $<_t_string>2 <<")" <<"IDENTIFIER("<< $<_t_string>3 <<")" <<")") CAst::postfix_expression_4 *obj=new CAst::postfix_expression_4(	$<_t_postfix_expression>1,new CAst::token($<_t_string>2),$<_t_argument_expression_list>3 ); LOG("Created postfix_expression_4: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression PTR_OP IDENTIFIER                                                                 	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"PTR_OP("<< $<_t_string>2 <<")" <<"IDENTIFIER("<< $<_t_string>3 <<")" <<")") CAst::postfix_expression_4 *obj=new CAst::postfix_expression_4(	$<_t_postfix_expression>1,new CAst::token($<_t_string>2),$<_t_argument_expression_list>3 ); LOG("Created postfix_expression_4: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression INC_OP                                                                            	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"INC_OP("<< $<_t_string>2 <<")" <<")") CAst::postfix_expression_3 *obj=new CAst::postfix_expression_3(	$<_t_postfix_expression>1,new CAst::token($<_t_string>2) ); LOG("Created postfix_expression_3: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression DEC_OP                                                                            	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"DEC_OP("<< $<_t_string>2 <<")" <<")") CAst::postfix_expression_3 *obj=new CAst::postfix_expression_3(	$<_t_postfix_expression>1,new CAst::token($<_t_string>2) ); LOG("Created postfix_expression_3: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	;
...
parameter_declaration 
	: declaration_specifiers declarator                                                                    	{ LOG("parameter_declaration:" <<"declaration_specifiers("<< $<_t_declaration_specifiers>1 <<")" <<"declarator("<< $<_t_declarator>2 <<")" <<")") CAst::parameter_declaration_2 *obj=new CAst::parameter_declaration_2(	$<_t_declaration_specifiers>1,$<_t_declarator>2 ); LOG("Created parameter_declaration_2: "<<obj)$<_t_parameter_declaration>$=obj; LOG("Returning :"<<$<_t_parameter_declaration>$) 	}
	| declaration_specifiers abstract_declarator                                                           	{ LOG("parameter_declaration:" <<"declaration_specifiers("<< $<_t_declaration_specifiers>1 <<")" <<"abstract_declarator("<< $<_t_abstract_declarator>2 <<")" <<")") CAst::parameter_declaration_1 *obj=new CAst::parameter_declaration_1(	$<_t_declaration_specifiers>1,$<_t_abstract_declarator>2 ); LOG("Created parameter_declaration_1: "<<obj)$<_t_parameter_declaration>$=obj; LOG("Returning :"<<$<_t_parameter_declaration>$) 	}
	| declaration_specifiers                                                                               	{ LOG("parameter_declaration:" <<"declaration_specifiers("<< $<_t_declaration_specifiers>1 <<")" <<")") CAst::parameter_declaration_2 *obj=new CAst::parameter_declaration_2(	$<_t_declaration_specifiers>1,NULL ); LOG("Created parameter_declaration_2: "<<obj)$<_t_parameter_declaration>$=obj; LOG("Returning :"<<$<_t_parameter_declaration>$) 	}
	;
...
declaration_specifiers 
	: storage_class_specifier                                                                              	{ LOG("declaration_specifiers:" <<"storage_class_specifier("<< $<_t_storage_class_specifier>1 <<")" <<")") CAst::declaration_specifiers_item_2 *obj=new CAst::declaration_specifiers_item_2(	$<_t_storage_class_specifier>1 ); LOG("Created declaration_specifiers_item_2: "<<obj)CAst::declaration_specifiers *lst=new CAst::declaration_specifiers;lst->append(obj);$<_t_declaration_specifiers>$=lst; LOG("Created List declaration_specifiers: "<<lst)LOG("Returning :"<<$<_t_declaration_specifiers>$) 	}
	| storage_class_specifier declaration_specifiers                                                       	{ LOG("declaration_specifiers:" <<"storage_class_specifier("<< $<_t_storage_class_specifier>1 <<")" <<"declaration_specifiers("<< $<_t_declaration_specifiers>2 <<")" <<")") CAst::declaration_specifiers_item_2 *obj=new CAst::declaration_specifiers_item_2(	$<_t_storage_class_specifier>1 ); LOG("Created declaration_specifiers_item_2: "<<obj)$<_t_declaration_specifiers>2 ->prepend(obj);$<_t_declaration_specifiers>$=$<_t_declaration_specifiers>2; LOG("Appended to declaration_specifiers") LOG("Returning :"<<$<_t_declaration_specifiers>$) 	}
	| type_specifier                                                                                       	{ LOG("declaration_specifiers:" <<"type_specifier("<< $<_t_type_specifier>1 <<")" <<")") CAst::declaration_specifiers_item_3 *obj=new CAst::declaration_specifiers_item_3(	$<_t_type_specifier>1 ); LOG("Created declaration_specifiers_item_3: "<<obj)CAst::declaration_specifiers *lst=new CAst::declaration_specifiers;lst->append(obj);$<_t_declaration_specifiers>$=lst; LOG("Created List declaration_specifiers: "<<lst)LOG("Returning :"<<$<_t_declaration_specifiers>$) 	}
	| type_specifier declaration_specifiers                                                                	{ LOG("declaration_specifiers:" <<"type_specifier("<< $<_t_type_specifier>1 <<")" <<"declaration_specifiers("<< $<_t_declaration_specifiers>2 <<")" <<")") CAst::declaration_specifiers_item_3 *obj=new CAst::declaration_specifiers_item_3(	$<_t_type_specifier>1 ); LOG("Created declaration_specifiers_item_3: "<<obj)$<_t_declaration_specifiers>2 ->prepend(obj);$<_t_declaration_specifiers>$=$<_t_declaration_specifiers>2; LOG("Appended to declaration_specifiers") LOG("Returning :"<<$<_t_declaration_specifiers>$) 	}
	| type_qualifier                                                                                       	{ LOG("declaration_specifiers:" <<"type_qualifier("<< $<_t_type_qualifier>1 <<")" <<")") CAst::declaration_specifiers_item_1 *obj=new CAst::declaration_specifiers_item_1(	$<_t_type_qualifier>1 ); LOG("Created declaration_specifiers_item_1: "<<obj)CAst::declaration_specifiers *lst=new CAst::declaration_specifiers;lst->append(obj);$<_t_declaration_specifiers>$=lst; LOG("Created List declaration_specifiers: "<<lst)LOG("Returning :"<<$<_t_declaration_specifiers>$) 	}
	| type_qualifier declaration_specifiers                                                                	{ LOG("declaration_specifiers:" <<"type_qualifier("<< $<_t_type_qualifier>1 <<")" <<"declaration_specifiers("<< $<_t_declaration_specifiers>2 <<")" <<")") CAst::declaration_specifiers_item_1 *obj=new CAst::declaration_specifiers_item_1(	$<_t_type_qualifier>1 ); LOG("Created declaration_specifiers_item_1: "<<obj)$<_t_declaration_specifiers>2 ->prepend(obj);$<_t_declaration_specifiers>$=$<_t_declaration_specifiers>2; LOG("Appended to declaration_specifiers") LOG("Returning :"<<$<_t_declaration_specifiers>$) 	}
	;
...
direct_declarator 
	: IDENTIFIER                                                                                           	{ LOG("direct_declarator:" <<"IDENTIFIER("<< $<_t_string>1 <<")" <<")") CAst::direct_declarator_5 *obj=new CAst::direct_declarator_5(	new CAst::token($<_t_string>1) ); LOG("Created direct_declarator_5: "<<obj)$<_t_direct_declarator>$=obj; LOG("Returning :"<<$<_t_direct_declarator>$) 	}
	| '(' declarator ')'                                                                                   	{ LOG("direct_declarator:" <<"'('("<< $<_t_string>1 <<")" <<"declarator("<< $<_t_declarator>2 <<")" <<"')'("<< $<_t_string>3 <<")" <<")") CAst::direct_declarator_1 *obj=new CAst::direct_declarator_1(	$<_t_declarator>2 ); LOG("Created direct_declarator_1: "<<obj)$<_t_direct_declarator>$=obj; LOG("Returning :"<<$<_t_direct_declarator>$) 	}
	| direct_declarator '[' constant_expression ']'                                                        	{ LOG("direct_declarator:" <<"direct_declarator("<< $<_t_direct_declarator>1 <<")" <<"'['("<< $<_t_string>2 <<")" <<"constant_expression("<< $<_t_constant_expression>3 <<")" <<"']'("<< $<_t_string>4 <<")" <<")") CAst::direct_declarator_2 *obj=new CAst::direct_declarator_2(	$<_t_direct_declarator>1,$<_t_constant_expression>3 ); LOG("Created direct_declarator_2: "<<obj)$<_t_direct_declarator>$=obj; LOG("Returning :"<<$<_t_direct_declarator>$) 	}
	| direct_declarator '[' ']'                                                                            	{ LOG("direct_declarator:" <<"direct_declarator("<< $<_t_direct_declarator>1 <<")" <<"'['("<< $<_t_string>2 <<")" <<"']'("<< $<_t_string>3 <<")" <<")") CAst::direct_declarator_2 *obj=new CAst::direct_declarator_2(	$<_t_direct_declarator>1,NULL ); LOG("Created direct_declarator_2: "<<obj)$<_t_direct_declarator>$=obj; LOG("Returning :"<<$<_t_direct_declarator>$) 	}
	...
	| direct_declarator '(' identifier_list ')'                                                            	{ LOG("direct_declarator:" <<"direct_declarator("<< $<_t_direct_declarator>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"identifier_list("<< $<_t_identifier_list>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<")") CAst::direct_declarator_4 *obj=new CAst::direct_declarator_4(	$<_t_direct_declarator>1,$<_t_identifier_list>3 ); LOG("Created direct_declarator_4: "<<obj)$<_t_direct_declarator>$=obj; LOG("Returning :"<<$<_t_direct_declarator>$) 	}
...
jump_statement 
	: GOTO IDENTIFIER ';'                                                                                  	{ LOG("jump_statement:" <<"GOTO("<< $<_t_string>1 <<")" <<"IDENTIFIER("<< $<_t_string>2 <<")" <<"';'("<< $<_t_string>3 <<")" <<")") CAst::jump_statement_3 *obj=new CAst::jump_statement_3(	new CAst::token($<_t_string>2) ); LOG("Created jump_statement_3: "<<obj)$<_t_jump_statement>$=obj; LOG("Returning :"<<$<_t_jump_statement>$) 	}
	| CONTINUE ';'                                                                                         	{ LOG("jump_statement:" <<"CONTINUE("<< $<_t_string>1 <<")" <<"';'("<< $<_t_string>2 <<")" <<")") CAst::jump_statement_1 *obj=new CAst::jump_statement_1(	new CAst::token($<_t_string>1) ); LOG("Created jump_statement_1: "<<obj)$<_t_jump_statement>$=obj; LOG("Returning :"<<$<_t_jump_statement>$) 	}
	| BREAK ';'                                                                                            	{ LOG("jump_statement:" <<"BREAK("<< $<_t_string>1 <<")" <<"';'("<< $<_t_string>2 <<")" <<")") CAst::jump_statement_1 *obj=new CAst::jump_statement_1(	new CAst::token($<_t_string>1) ); LOG("Created jump_statement_1: "<<obj)$<_t_jump_statement>$=obj; LOG("Returning :"<<$<_t_jump_statement>$) 	}
...
specifier_qualifier_list 
	: type_specifier specifier_qualifier_list                                                              	{ LOG("specifier_qualifier_list:" <<"type_specifier("<< $<_t_type_specifier>1 <<")" <<"specifier_qualifier_list("<< $<_t_specifier_qualifier_list>2 <<")" <<")") CAst::specifier_qualifier_list_item_2 *obj=new CAst::specifier_qualifier_list_item_2(	$<_t_type_specifier>1 ); LOG("Created specifier_qualifier_list_item_2: "<<obj)$<_t_specifier_qualifier_list>2 ->prepend(obj);$<_t_specifier_qualifier_list>$=$<_t_specifier_qualifier_list>2; LOG("Appended to specifier_qualifier_list") LOG("Returning :"<<$<_t_specifier_qualifier_list>$) 	}
	| type_specifier                                                                                       	{ LOG("specifier_qualifier_list:" <<"type_specifier("<< $<_t_type_specifier>1 <<")" <<")") CAst::specifier_qualifier_list_item_2 *obj=new CAst::specifier_qualifier_list_item_2(	$<_t_type_specifier>1 ); LOG("Created specifier_qualifier_list_item_2: "<<obj)CAst::specifier_qualifier_list *lst=new CAst::specifier_qualifier_list;lst->append(obj);$<_t_specifier_qualifier_list>$=lst; LOG("Created List specifier_qualifier_list: "<<lst)LOG("Returning :"<<$<_t_specifier_qualifier_list>$) 	}
	| type_qualifier specifier_qualifier_list                                                              	{ LOG("specifier_qualifier_list:" <<"type_qualifier("<< $<_t_type_qualifier>1 <<")" <<"specifier_qualifier_list("<< $<_t_specifier_qualifier_list>2 <<")" <<")") CAst::specifier_qualifier_list_item_1 *obj=new CAst::specifier_qualifier_list_item_1(	$<_t_type_qualifier>1 ); LOG("Created specifier_qualifier_list_item_1: "<<obj)$<_t_specifier_qualifier_list>2 ->prepend(obj);$<_t_specifier_qualifier_list>$=$<_t_specifier_qualifier_list>2; LOG("Appended to specifier_qualifier_list") LOG("Returning :"<<$<_t_specifier_qualifier_list>$) 	}
	| type_qualifier                                                                                       	{ LOG("specifier_qualifier_list:" <<"type_qualifier("<< $<_t_type_qualifier>1 <<")" <<")") CAst::specifier_qualifier_list_item_1 *obj=new CAst::specifier_qualifier_list_item_1(	$<_t_type_qualifier>1 ); LOG("Created specifier_qualifier_list_item_1: "<<obj)CAst::specifier_qualifier_list *lst=new CAst::specifier_qualifier_list;lst->append(obj);$<_t_specifier_qualifier_list>$=lst; LOG("Created List specifier_qualifier_list: "<<lst)LOG("Returning :"<<$<_t_specifier_qualifier_list>$) 	}
	;
