...
unary_expression 
	: postfix_expression                                                                                   	{ LOG("unary_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<")") CAst::unary_expression_3 *obj=new CAst::unary_expression_3(	$<_t_postfix_expression>1 ); LOG("Created unary_expression_3: "<<obj)$<_t_unary_expression>$=obj; LOG("Returning :"<<$<_t_unary_expression>$) 	}
	| INC_OP unary_expression                                                                              	{ LOG("unary_expression:" <<"INC_OP("<< $<_t_string>1 <<")" <<"unary_expression("<< $<_t_unary_expression>2 <<")" <<")") CAst::unary_expression_4 *obj=new CAst::unary_expression_4(	new CAst::token($<_t_string>1),$<_t_unary_expression>2 ); LOG("Created unary_expression_4: "<<obj)$<_t_unary_expression>$=obj; LOG("Returning :"<<$<_t_unary_expression>$) 	}
	| DEC_OP unary_expression                                                                              	{ LOG("unary_expression:" <<"DEC_OP("<< $<_t_string>1 <<")" <<"unary_expression("<< $<_t_unary_expression>2 <<")" <<")") CAst::unary_expression_4 *obj=new CAst::unary_expression_4(	new CAst::token($<_t_string>1),$<_t_unary_expression>2 ); LOG("Created unary_expression_4: "<<obj)$<_t_unary_expression>$=obj; LOG("Returning :"<<$<_t_unary_expression>$) 	}
	| unary_operator cast_expression                                                                       	{ LOG("unary_expression:" <<"unary_operator("<< $<_t_unary_operator>1 <<")" <<"cast_expression("<< $<_t_cast_expression>2 <<")" <<")") CAst::unary_expression_1 *obj=new CAst::unary_expression_1(	$<_t_unary_operator>1,$<_t_cast_expression>2 ); LOG("Created unary_expression_1: "<<obj)$<_t_unary_expression>$=obj; LOG("Returning :"<<$<_t_unary_expression>$) 	}
	| SIZEOF unary_expression                                                                              	{ LOG("unary_expression:" <<"SIZEOF("<< $<_t_string>1 <<")" <<"unary_expression("<< $<_t_unary_expression>2 <<")" <<")") CAst::unary_expression_4 *obj=new CAst::unary_expression_4(	new CAst::token($<_t_string>1),$<_t_unary_expression>2 ); LOG("Created unary_expression_4: "<<obj)$<_t_unary_expression>$=obj; LOG("Returning :"<<$<_t_unary_expression>$) 	}
...
external_declaration 
	: function_definition                                                                                  	{ LOG("external_declaration:" <<"function_definition("<< $<_t_function_definition>1 <<")" <<")") CAst::external_declaration_1 *obj=new CAst::external_declaration_1(	$<_t_function_definition>1 ); LOG("Created external_declaration_1: "<<obj)$<_t_external_declaration>$=obj; LOG("Returning :"<<$<_t_external_declaration>$) 	}
	| declaration                                                                                          	{ LOG("external_declaration:" <<"declaration("<< $<_t_declaration>1 <<")" <<")") CAst::external_declaration_2 *obj=new CAst::external_declaration_2(	$<_t_declaration>1 ); LOG("Created external_declaration_2: "<<obj)$<_t_external_declaration>$=obj; LOG("Returning :"<<$<_t_external_declaration>$) 	}
	;
...
selection_statement 
	: IF '(' expression ')' statement                                                                      	{ LOG("selection_statement:" <<"IF("<< $<_t_string>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"expression("<< $<_t_expression>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<"statement("<< $<_t_statement>5 <<")" <<")") CAst::selection_statement_2 *obj=new CAst::selection_statement_2(	$<_t_expression>3,$<_t_statement>5,NULL,NULL ); LOG("Created selection_statement_2: "<<obj)$<_t_selection_statement>$=obj; LOG("Returning :"<<$<_t_selection_statement>$) 	}
	| IF '(' expression ')' statement ELSE statement                                                       	{ LOG("selection_statement:" <<"IF("<< $<_t_string>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"expression("<< $<_t_expression>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<"statement("<< $<_t_statement>5 <<")" <<"ELSE("<< $<_t_string>6 <<")" <<"statement("<< $<_t_statement>7 <<")" <<")") CAst::selection_statement_2 *obj=new CAst::selection_statement_2(	$<_t_expression>3,$<_t_statement>5,new CAst::token($<_t_string>6),$<_t_statement>7 ); LOG("Created selection_statement_2: "<<obj)$<_t_selection_statement>$=obj; LOG("Returning :"<<$<_t_selection_statement>$) 	}
	| SWITCH '(' expression ')' statement                                                                  	{ LOG("selection_statement:" <<"SWITCH("<< $<_t_string>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"expression("<< $<_t_expression>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<"statement("<< $<_t_statement>5 <<")" <<")") CAst::selection_statement_1 *obj=new CAst::selection_statement_1(	$<_t_expression>3,$<_t_statement>5 ); LOG("Created selection_statement_1: "<<obj)$<_t_selection_statement>$=obj; LOG("Returning :"<<$<_t_selection_statement>$) 	}
	;
...
postfix_expression 
	...
	| postfix_expression '(' ')'                                                                           	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"')'("<< $<_t_string>3 <<")" <<")") CAst::postfix_expression_5 *obj=new CAst::postfix_expression_5(	$<_t_postfix_expression>1,NULL ); LOG("Created postfix_expression_5: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression '(' argument_expression_list ')'                                                  	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"argument_expression_list("<< $<_t_argument_expression_list>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<")") CAst::postfix_expression_5 *obj=new CAst::postfix_expression_5(	$<_t_postfix_expression>1,$<_t_argument_expression_list>3 ); LOG("Created postfix_expression_5: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression '.' IDENTIFIER                                                                    	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"'.'("<< $<_t_string>2 <<")" <<"IDENTIFIER("<< $<_t_string>3 <<")" <<")") CAst::postfix_expression_4 *obj=new CAst::postfix_expression_4(	$<_t_postfix_expression>1,new CAst::token($<_t_string>2),new CAst::token($<_t_string>3) ); LOG("Created postfix_expression_4: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression PTR_OP IDENTIFIER                                                                 	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"PTR_OP("<< $<_t_string>2 <<")" <<"IDENTIFIER("<< $<_t_string>3 <<")" <<")") CAst::postfix_expression_4 *obj=new CAst::postfix_expression_4(	$<_t_postfix_expression>1,new CAst::token($<_t_string>2),new CAst::token($<_t_string>3) ); LOG("Created postfix_expression_4: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression INC_OP                                                                            	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"INC_OP("<< $<_t_string>2 <<")" <<")") CAst::postfix_expression_2 *obj=new CAst::postfix_expression_2(	$<_t_postfix_expression>1,new CAst::token($<_t_string>2) ); LOG("Created postfix_expression_2: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression DEC_OP                                                                            	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"DEC_OP("<< $<_t_string>2 <<")" <<")") CAst::postfix_expression_2 *obj=new CAst::postfix_expression_2(	$<_t_postfix_expression>1,new CAst::token($<_t_string>2) ); LOG("Created postfix_expression_2: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	;
...
direct_abstract_declarator 
	: '(' abstract_declarator ')'                                                                          	{ LOG("direct_abstract_declarator:" <<"'('("<< $<_t_string>1 <<")" <<"abstract_declarator("<< $<_t_abstract_declarator>2 <<")" <<"')'("<< $<_t_string>3 <<")" <<")") CAst::direct_abstract_declarator_1 *obj=new CAst::direct_abstract_declarator_1(	$<_t_abstract_declarator>2 ); LOG("Created direct_abstract_declarator_1: "<<obj)$<_t_direct_abstract_declarator>$=obj; LOG("Returning :"<<$<_t_direct_abstract_declarator>$) 	}
...
direct_declarator 
	: IDENTIFIER                                                                                           	{ LOG("direct_declarator:" <<"IDENTIFIER("<< $<_t_string>1 <<")" <<")") CAst::direct_declarator_2 *obj=new CAst::direct_declarator_2(	new CAst::token($<_t_string>1) ); LOG("Created direct_declarator_2: "<<obj)$<_t_direct_declarator>$=obj; LOG("Returning :"<<$<_t_direct_declarator>$) 	}
	| '(' declarator ')'                                                                                   	{ LOG("direct_declarator:" <<"'('("<< $<_t_string>1 <<")" <<"declarator("<< $<_t_declarator>2 <<")" <<"')'("<< $<_t_string>3 <<")" <<")") CAst::direct_declarator_4 *obj=new CAst::direct_declarator_4(	$<_t_declarator>2 ); LOG("Created direct_declarator_4: "<<obj)$<_t_direct_declarator>$=obj; LOG("Returning :"<<$<_t_direct_declarator>$) 	}
	...
	| direct_declarator '(' identifier_list ')'                                                            	{ LOG("direct_declarator:" <<"direct_declarator("<< $<_t_direct_declarator>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"identifier_list("<< $<_t_identifier_list>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<")") CAst::direct_declarator_5 *obj=new CAst::direct_declarator_5(	$<_t_direct_declarator>1,$<_t_identifier_list>3 ); LOG("Created direct_declarator_5: "<<obj)$<_t_direct_declarator>$=obj; LOG("Returning :"<<$<_t_direct_declarator>$) 	}
...
jump_statement 
	: GOTO IDENTIFIER ';'                                                                                  	{ LOG("jump_statement:" <<"GOTO("<< $<_t_string>1 <<")" <<"IDENTIFIER("<< $<_t_string>2 <<")" <<"';'("<< $<_t_string>3 <<")" <<")") CAst::jump_statement_2 *obj=new CAst::jump_statement_2(	new CAst::token($<_t_string>2) ); LOG("Created jump_statement_2: "<<obj)$<_t_jump_statement>$=obj; LOG("Returning :"<<$<_t_jump_statement>$) 	}
	...
	| RETURN ';'                                                                                           	{ LOG("jump_statement:" <<"RETURN("<< $<_t_string>1 <<")" <<"';'("<< $<_t_string>2 <<")" <<")") CAst::jump_statement_1 *obj=new CAst::jump_statement_1(	NULL ); LOG("Created jump_statement_1: "<<obj)$<_t_jump_statement>$=obj; LOG("Returning :"<<$<_t_jump_statement>$) 	}
	| RETURN expression ';'                                                                                	{ LOG("jump_statement:" <<"RETURN("<< $<_t_string>1 <<")" <<"expression("<< $<_t_expression>2 <<")" <<"';'("<< $<_t_string>3 <<")" <<")") CAst::jump_statement_1 *obj=new CAst::jump_statement_1(	$<_t_expression>2 ); LOG("Created jump_statement_1: "<<obj)$<_t_jump_statement>$=obj; LOG("Returning :"<<$<_t_jump_statement>$) 	}
	;
