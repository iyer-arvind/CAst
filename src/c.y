...
unary_expression 
	: postfix_expression                                                                                   	{ LOG("unary_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<")") CAst::unary_expression_1 *obj=new CAst::unary_expression_1(	$<_t_postfix_expression>1 ); LOG("Created unary_expression_1: "<<obj)$<_t_unary_expression>$=obj; LOG("Returning :"<<$<_t_unary_expression>$) 	}
	| INC_OP unary_expression                                                                              	{ LOG("unary_expression:" <<"INC_OP("<< $<_t_string>1 <<")" <<"unary_expression("<< $<_t_unary_expression>2 <<")" <<")") CAst::unary_expression_3 *obj=new CAst::unary_expression_3(	new CAst::token($<_t_string>1),$<_t_unary_expression>2 ); LOG("Created unary_expression_3: "<<obj)$<_t_unary_expression>$=obj; LOG("Returning :"<<$<_t_unary_expression>$) 	}
	| DEC_OP unary_expression                                                                              	{ LOG("unary_expression:" <<"DEC_OP("<< $<_t_string>1 <<")" <<"unary_expression("<< $<_t_unary_expression>2 <<")" <<")") CAst::unary_expression_3 *obj=new CAst::unary_expression_3(	new CAst::token($<_t_string>1),$<_t_unary_expression>2 ); LOG("Created unary_expression_3: "<<obj)$<_t_unary_expression>$=obj; LOG("Returning :"<<$<_t_unary_expression>$) 	}
	| unary_operator cast_expression                                                                       	{ LOG("unary_expression:" <<"unary_operator("<< $<_t_unary_operator>1 <<")" <<"cast_expression("<< $<_t_cast_expression>2 <<")" <<")") CAst::unary_expression_4 *obj=new CAst::unary_expression_4(	$<_t_unary_operator>1,$<_t_cast_expression>2 ); LOG("Created unary_expression_4: "<<obj)$<_t_unary_expression>$=obj; LOG("Returning :"<<$<_t_unary_expression>$) 	}
	| SIZEOF unary_expression                                                                              	{ LOG("unary_expression:" <<"SIZEOF("<< $<_t_string>1 <<")" <<"unary_expression("<< $<_t_unary_expression>2 <<")" <<")") CAst::unary_expression_3 *obj=new CAst::unary_expression_3(	new CAst::token($<_t_string>1),$<_t_unary_expression>2 ); LOG("Created unary_expression_3: "<<obj)$<_t_unary_expression>$=obj; LOG("Returning :"<<$<_t_unary_expression>$) 	}
	| SIZEOF '(' type_name ')'                                                                             	{ LOG("unary_expression:" <<"SIZEOF("<< $<_t_string>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"type_name("<< $<_t_type_name>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<")") CAst::unary_expression_2 *obj=new CAst::unary_expression_2(	$<_t_type_name>3 ); LOG("Created unary_expression_2: "<<obj)$<_t_unary_expression>$=obj; LOG("Returning :"<<$<_t_unary_expression>$) 	}
	;



conditional_expression 
	: logical_or_expression                                                                                	{ LOG("conditional_expression:" <<"logical_or_expression("<< $<_t_logical_or_expression>1 <<")" <<")") CAst::conditional_expression_item *obj=new CAst::conditional_expression_item(	$<_t_logical_or_expression>1,NULL,NULL,NULL ); LOG("Created conditional_expression_item: "<<obj)CAst::conditional_expression *lst=new CAst::conditional_expression;lst->append(obj);$<_t_conditional_expression>$=lst; LOG("Created List conditional_expression: "<<lst)LOG("Returning :"<<$<_t_conditional_expression>$) 	}
	| logical_or_expression '?' expression ':' conditional_expression                                      	{ LOG("conditional_expression:" <<"logical_or_expression("<< $<_t_logical_or_expression>1 <<")" <<"'?'("<< $<_t_string>2 <<")" <<"expression("<< $<_t_expression>3 <<")" <<"':'("<< $<_t_string>4 <<")" <<"conditional_expression("<< $<_t_conditional_expression>5 <<")" <<")") CAst::conditional_expression_item *obj=new CAst::conditional_expression_item(	$<_t_logical_or_expression>1,new CAst::token($<_t_string>2),$<_t_expression>3,new CAst::token($<_t_string>4) ); LOG("Created conditional_expression_item: "<<obj)$<_t_conditional_expression>5 ->prepend(obj);$<_t_conditional_expression>$=$<_t_conditional_expression>5; LOG("Appended to conditional_expression") LOG("Returning :"<<$<_t_conditional_expression>$) 	}
	;
...
exclusive_or_expression 
	: and_expression                                                                                       	{ LOG("exclusive_or_expression:" <<"and_expression("<< $<_t_and_expression>1 <<")" <<")") CAst::exclusive_or_expression_item *obj=new CAst::exclusive_or_expression_item(	NULL,$<_t_and_expression>1 ); LOG("Created exclusive_or_expression_item: "<<obj)CAst::exclusive_or_expression *lst=new CAst::exclusive_or_expression;lst->append(obj);$<_t_exclusive_or_expression>$=lst; LOG("Created List exclusive_or_expression: "<<lst)LOG("Returning :"<<$<_t_exclusive_or_expression>$) 	}
	| exclusive_or_expression '^' and_expression                                                           	{ LOG("exclusive_or_expression:" <<"exclusive_or_expression("<< $<_t_exclusive_or_expression>1 <<")" <<"'^'("<< $<_t_string>2 <<")" <<"and_expression("<< $<_t_and_expression>3 <<")" <<")") CAst::exclusive_or_expression_item *obj=new CAst::exclusive_or_expression_item(	new CAst::token($<_t_string>2),$<_t_and_expression>3 ); LOG("Created exclusive_or_expression_item: "<<obj)$<_t_exclusive_or_expression>1 ->append(obj);$<_t_exclusive_or_expression>$=$<_t_exclusive_or_expression>1; LOG("Appended to exclusive_or_expression") LOG("Returning :"<<$<_t_exclusive_or_expression>$) 	}
	;
...
iteration_statement 
	: WHILE '(' expression ')' statement                                                                   	{ LOG("iteration_statement:" <<"WHILE("<< $<_t_string>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"expression("<< $<_t_expression>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<"statement("<< $<_t_statement>5 <<")" <<")") CAst::iteration_statement_1 *obj=new CAst::iteration_statement_1(	$<_t_expression>3,$<_t_statement>5 ); LOG("Created iteration_statement_1: "<<obj)$<_t_iteration_statement>$=obj; LOG("Returning :"<<$<_t_iteration_statement>$) 	}
	| DO statement WHILE '(' expression ')' ';'                                                            	{ LOG("iteration_statement:" <<"DO("<< $<_t_string>1 <<")" <<"statement("<< $<_t_statement>2 <<")" <<"WHILE("<< $<_t_string>3 <<")" <<"'('("<< $<_t_string>4 <<")" <<"expression("<< $<_t_expression>5 <<")" <<"')'("<< $<_t_string>6 <<")" <<"';'("<< $<_t_string>7 <<")" <<")") CAst::iteration_statement_2 *obj=new CAst::iteration_statement_2(	$<_t_statement>2,$<_t_expression>5 ); LOG("Created iteration_statement_2: "<<obj)$<_t_iteration_statement>$=obj; LOG("Returning :"<<$<_t_iteration_statement>$) 	}
	| FOR '(' expression_statement expression_statement ')' statement                                      	{ LOG("iteration_statement:" <<"FOR("<< $<_t_string>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"expression_statement("<< $<_t_expression_statement>3 <<")" <<"expression_statement("<< $<_t_expression_statement>4 <<")" <<"')'("<< $<_t_string>5 <<")" <<"statement("<< $<_t_statement>6 <<")" <<")") CAst::iteration_statement_3 *obj=new CAst::iteration_statement_3(	$<_t_expression_statement>3,$<_t_expression_statement>4,NULL,$<_t_statement>6 ); LOG("Created iteration_statement_3: "<<obj)$<_t_iteration_statement>$=obj; LOG("Returning :"<<$<_t_iteration_statement>$) 	}
	| FOR '(' expression_statement expression_statement expression ')' statement                           	{ LOG("iteration_statement:" <<"FOR("<< $<_t_string>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"expression_statement("<< $<_t_expression_statement>3 <<")" <<"expression_statement("<< $<_t_expression_statement>4 <<")" <<"expression("<< $<_t_expression>5 <<")" <<"')'("<< $<_t_string>6 <<")" <<"statement("<< $<_t_statement>7 <<")" <<")") CAst::iteration_statement_3 *obj=new CAst::iteration_statement_3(	$<_t_expression_statement>3,$<_t_expression_statement>4,$<_t_expression>5,$<_t_statement>7 ); LOG("Created iteration_statement_3: "<<obj)$<_t_iteration_statement>$=obj; LOG("Returning :"<<$<_t_iteration_statement>$) 	}
	;
...
type_specifier 
	: VOID                                                                                                 	{ LOG("type_specifier:" <<"VOID("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_1 *obj=new CAst::type_specifier_1(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_1: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| CHAR                                                                                                 	{ LOG("type_specifier:" <<"CHAR("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_1 *obj=new CAst::type_specifier_1(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_1: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| SHORT                                                                                                	{ LOG("type_specifier:" <<"SHORT("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_1 *obj=new CAst::type_specifier_1(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_1: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| INT                                                                                                  	{ LOG("type_specifier:" <<"INT("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_1 *obj=new CAst::type_specifier_1(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_1: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| LONG                                                                                                 	{ LOG("type_specifier:" <<"LONG("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_1 *obj=new CAst::type_specifier_1(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_1: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| FLOAT                                                                                                	{ LOG("type_specifier:" <<"FLOAT("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_1 *obj=new CAst::type_specifier_1(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_1: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| DOUBLE                                                                                               	{ LOG("type_specifier:" <<"DOUBLE("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_1 *obj=new CAst::type_specifier_1(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_1: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| SIGNED                                                                                               	{ LOG("type_specifier:" <<"SIGNED("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_1 *obj=new CAst::type_specifier_1(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_1: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| UNSIGNED                                                                                             	{ LOG("type_specifier:" <<"UNSIGNED("<< $<_t_string>1 <<")" <<")") CAst::type_specifier_1 *obj=new CAst::type_specifier_1(	new CAst::token($<_t_string>1) ); LOG("Created type_specifier_1: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| struct_or_union_specifier                                                                            	{ LOG("type_specifier:" <<"struct_or_union_specifier("<< $<_t_struct_or_union_specifier>1 <<")" <<")") CAst::type_specifier_2 *obj=new CAst::type_specifier_2(	$<_t_struct_or_union_specifier>1 ); LOG("Created type_specifier_2: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	| enum_specifier                                                                                       	{ LOG("type_specifier:" <<"enum_specifier("<< $<_t_enum_specifier>1 <<")" <<")") CAst::type_specifier_3 *obj=new CAst::type_specifier_3(	$<_t_enum_specifier>1 ); LOG("Created type_specifier_3: "<<obj)$<_t_type_specifier>$=obj; LOG("Returning :"<<$<_t_type_specifier>$) 	}
	;
...
inclusive_or_expression 
	: exclusive_or_expression                                                                              	{ LOG("inclusive_or_expression:" <<"exclusive_or_expression("<< $<_t_exclusive_or_expression>1 <<")" <<")") CAst::inclusive_or_expression_item *obj=new CAst::inclusive_or_expression_item(	NULL,$<_t_exclusive_or_expression>1 ); LOG("Created inclusive_or_expression_item: "<<obj)CAst::inclusive_or_expression *lst=new CAst::inclusive_or_expression;lst->append(obj);$<_t_inclusive_or_expression>$=lst; LOG("Created List inclusive_or_expression: "<<lst)LOG("Returning :"<<$<_t_inclusive_or_expression>$) 	}
	| inclusive_or_expression '|' exclusive_or_expression                                                  	{ LOG("inclusive_or_expression:" <<"inclusive_or_expression("<< $<_t_inclusive_or_expression>1 <<")" <<"'|'("<< $<_t_string>2 <<")" <<"exclusive_or_expression("<< $<_t_exclusive_or_expression>3 <<")" <<")") CAst::inclusive_or_expression_item *obj=new CAst::inclusive_or_expression_item(	new CAst::token($<_t_string>2),$<_t_exclusive_or_expression>3 ); LOG("Created inclusive_or_expression_item: "<<obj)$<_t_inclusive_or_expression>1 ->append(obj);$<_t_inclusive_or_expression>$=$<_t_inclusive_or_expression>1; LOG("Appended to inclusive_or_expression") LOG("Returning :"<<$<_t_inclusive_or_expression>$) 	}
	;



pointer 
	: '*'                                                                                                  	{ LOG("pointer:" <<"'*'("<< $<_t_string>1 <<")" <<")") CAst::pointer_item_1 *obj=new CAst::pointer_item_1(	NULL ); LOG("Created pointer_item_1: "<<obj)CAst::pointer *lst=new CAst::pointer;lst->append(obj);$<_t_pointer>$=lst; LOG("Created List pointer: "<<lst)LOG("Returning :"<<$<_t_pointer>$) 	}
	| '*' type_qualifier_list                                                                              	{ LOG("pointer:" <<"'*'("<< $<_t_string>1 <<")" <<"type_qualifier_list("<< $<_t_type_qualifier_list>2 <<")" <<")") CAst::pointer_item_1 *obj=new CAst::pointer_item_1(	$<_t_type_qualifier_list>2 ); LOG("Created pointer_item_1: "<<obj)CAst::pointer *lst=new CAst::pointer;lst->append(obj);$<_t_pointer>$=lst; LOG("Created List pointer: "<<lst)LOG("Returning :"<<$<_t_pointer>$) 	}
	| '*' pointer                                                                                          	{ LOG("pointer:" <<"'*'("<< $<_t_string>1 <<")" <<"pointer("<< $<_t_pointer>2 <<")" <<")") CAst::pointer_item_2 *obj=new CAst::pointer_item_2(	 ); LOG("Created pointer_item_2: "<<obj)$<_t_pointer>2 ->prepend(obj);$<_t_pointer>$=$<_t_pointer>2; LOG("Appended to pointer") LOG("Returning :"<<$<_t_pointer>$) 	}
	| '*' type_qualifier_list pointer                                                                      	{ LOG("pointer:" <<"'*'("<< $<_t_string>1 <<")" <<"type_qualifier_list("<< $<_t_type_qualifier_list>2 <<")" <<"pointer("<< $<_t_pointer>3 <<")" <<")") CAst::pointer_item_1 *obj=new CAst::pointer_item_1(	$<_t_type_qualifier_list>2 ); LOG("Created pointer_item_1: "<<obj)$<_t_pointer>3 ->prepend(obj);$<_t_pointer>$=$<_t_pointer>3; LOG("Appended to pointer") LOG("Returning :"<<$<_t_pointer>$) 	}
	;



selection_statement 
	: IF '(' expression ')' statement                                                                      	{ LOG("selection_statement:" <<"IF("<< $<_t_string>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"expression("<< $<_t_expression>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<"statement("<< $<_t_statement>5 <<")" <<")") CAst::selection_statement_1 *obj=new CAst::selection_statement_1(	$<_t_expression>3,$<_t_statement>5,NULL,NULL ); LOG("Created selection_statement_1: "<<obj)$<_t_selection_statement>$=obj; LOG("Returning :"<<$<_t_selection_statement>$) 	}
	| IF '(' expression ')' statement ELSE statement                                                       	{ LOG("selection_statement:" <<"IF("<< $<_t_string>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"expression("<< $<_t_expression>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<"statement("<< $<_t_statement>5 <<")" <<"ELSE("<< $<_t_string>6 <<")" <<"statement("<< $<_t_statement>7 <<")" <<")") CAst::selection_statement_1 *obj=new CAst::selection_statement_1(	$<_t_expression>3,$<_t_statement>5,new CAst::token($<_t_string>6),$<_t_statement>7 ); LOG("Created selection_statement_1: "<<obj)$<_t_selection_statement>$=obj; LOG("Returning :"<<$<_t_selection_statement>$) 	}
	| SWITCH '(' expression ')' statement                                                                  	{ LOG("selection_statement:" <<"SWITCH("<< $<_t_string>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"expression("<< $<_t_expression>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<"statement("<< $<_t_statement>5 <<")" <<")") CAst::selection_statement_2 *obj=new CAst::selection_statement_2(	$<_t_expression>3,$<_t_statement>5 ); LOG("Created selection_statement_2: "<<obj)$<_t_selection_statement>$=obj; LOG("Returning :"<<$<_t_selection_statement>$) 	}
	;



postfix_expression 
	: primary_expression                                                                                   	{ LOG("postfix_expression:" <<"primary_expression("<< $<_t_primary_expression>1 <<")" <<")") CAst::postfix_expression_1 *obj=new CAst::postfix_expression_1(	$<_t_primary_expression>1 ); LOG("Created postfix_expression_1: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression '[' expression ']'                                                                	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"'['("<< $<_t_string>2 <<")" <<"expression("<< $<_t_expression>3 <<")" <<"']'("<< $<_t_string>4 <<")" <<")") CAst::postfix_expression_3 *obj=new CAst::postfix_expression_3(	$<_t_postfix_expression>1,$<_t_expression>3 ); LOG("Created postfix_expression_3: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression '(' ')'                                                                           	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"')'("<< $<_t_string>3 <<")" <<")") CAst::postfix_expression_4 *obj=new CAst::postfix_expression_4(	$<_t_postfix_expression>1,NULL ); LOG("Created postfix_expression_4: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression '(' argument_expression_list ')'                                                  	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"argument_expression_list("<< $<_t_argument_expression_list>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<")") CAst::postfix_expression_4 *obj=new CAst::postfix_expression_4(	$<_t_postfix_expression>1,$<_t_argument_expression_list>3 ); LOG("Created postfix_expression_4: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression '.' IDENTIFIER                                                                    	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"'.'("<< $<_t_string>2 <<")" <<"IDENTIFIER("<< $<_t_string>3 <<")" <<")") CAst::postfix_expression_2 *obj=new CAst::postfix_expression_2(	$<_t_postfix_expression>1,new CAst::token($<_t_string>2),new CAst::token($<_t_string>3) ); LOG("Created postfix_expression_2: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression PTR_OP IDENTIFIER                                                                 	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"PTR_OP("<< $<_t_string>2 <<")" <<"IDENTIFIER("<< $<_t_string>3 <<")" <<")") CAst::postfix_expression_2 *obj=new CAst::postfix_expression_2(	$<_t_postfix_expression>1,new CAst::token($<_t_string>2),new CAst::token($<_t_string>3) ); LOG("Created postfix_expression_2: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression INC_OP                                                                            	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"INC_OP("<< $<_t_string>2 <<")" <<")") CAst::postfix_expression_5 *obj=new CAst::postfix_expression_5(	$<_t_postfix_expression>1,new CAst::token($<_t_string>2) ); LOG("Created postfix_expression_5: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression DEC_OP                                                                            	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"DEC_OP("<< $<_t_string>2 <<")" <<")") CAst::postfix_expression_5 *obj=new CAst::postfix_expression_5(	$<_t_postfix_expression>1,new CAst::token($<_t_string>2) ); LOG("Created postfix_expression_5: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	;



and_expression 
	: equality_expression                                                                                  	{ LOG("and_expression:" <<"equality_expression("<< $<_t_equality_expression>1 <<")" <<")") CAst::and_expression_item *obj=new CAst::and_expression_item(	NULL,$<_t_equality_expression>1 ); LOG("Created and_expression_item: "<<obj)CAst::and_expression *lst=new CAst::and_expression;lst->append(obj);$<_t_and_expression>$=lst; LOG("Created List and_expression: "<<lst)LOG("Returning :"<<$<_t_and_expression>$) 	}
	| and_expression '&' equality_expression                                                               	{ LOG("and_expression:" <<"and_expression("<< $<_t_and_expression>1 <<")" <<"'&'("<< $<_t_string>2 <<")" <<"equality_expression("<< $<_t_equality_expression>3 <<")" <<")") CAst::and_expression_item *obj=new CAst::and_expression_item(	new CAst::token($<_t_string>2),$<_t_equality_expression>3 ); LOG("Created and_expression_item: "<<obj)$<_t_and_expression>1 ->append(obj);$<_t_and_expression>$=$<_t_and_expression>1; LOG("Appended to and_expression") LOG("Returning :"<<$<_t_and_expression>$) 	}
	;



statement 
	: labeled_statement                                                                                    	{ LOG("statement:" <<"labeled_statement("<< $<_t_labeled_statement>1 <<")" <<")") CAst::statement_4 *obj=new CAst::statement_4(	$<_t_labeled_statement>1 ); LOG("Created statement_4: "<<obj)$<_t_statement>$=obj; LOG("Returning :"<<$<_t_statement>$) 	}
	| compound_statement                                                                                   	{ LOG("statement:" <<"compound_statement("<< $<_t_compound_statement>1 <<")" <<")") CAst::statement_5 *obj=new CAst::statement_5(	$<_t_compound_statement>1 ); LOG("Created statement_5: "<<obj)$<_t_statement>$=obj; LOG("Returning :"<<$<_t_statement>$) 	}
	| expression_statement                                                                                 	{ LOG("statement:" <<"expression_statement("<< $<_t_expression_statement>1 <<")" <<")") CAst::statement_6 *obj=new CAst::statement_6(	$<_t_expression_statement>1 ); LOG("Created statement_6: "<<obj)$<_t_statement>$=obj; LOG("Returning :"<<$<_t_statement>$) 	}
	| selection_statement                                                                                  	{ LOG("statement:" <<"selection_statement("<< $<_t_selection_statement>1 <<")" <<")") CAst::statement_1 *obj=new CAst::statement_1(	$<_t_selection_statement>1 ); LOG("Created statement_1: "<<obj)$<_t_statement>$=obj; LOG("Returning :"<<$<_t_statement>$) 	}
	| iteration_statement                                                                                  	{ LOG("statement:" <<"iteration_statement("<< $<_t_iteration_statement>1 <<")" <<")") CAst::statement_2 *obj=new CAst::statement_2(	$<_t_iteration_statement>1 ); LOG("Created statement_2: "<<obj)$<_t_statement>$=obj; LOG("Returning :"<<$<_t_statement>$) 	}
	| jump_statement                                                                                       	{ LOG("statement:" <<"jump_statement("<< $<_t_jump_statement>1 <<")" <<")") CAst::statement_3 *obj=new CAst::statement_3(	$<_t_jump_statement>1 ); LOG("Created statement_3: "<<obj)$<_t_statement>$=obj; LOG("Returning :"<<$<_t_statement>$) 	}
	;



cast_expression 
	: unary_expression                                                                                     	{ LOG("cast_expression:" <<"unary_expression("<< $<_t_unary_expression>1 <<")" <<")") CAst::cast_expression_1 *obj=new CAst::cast_expression_1(	$<_t_unary_expression>1 ); LOG("Created cast_expression_1: "<<obj)$<_t_cast_expression>$=obj; LOG("Returning :"<<$<_t_cast_expression>$) 	}
	| '(' type_name ')' cast_expression                                                                    	{ LOG("cast_expression:" <<"'('("<< $<_t_string>1 <<")" <<"type_name("<< $<_t_type_name>2 <<")" <<"')'("<< $<_t_string>3 <<")" <<"cast_expression("<< $<_t_cast_expression>4 <<")" <<")") CAst::cast_expression_2 *obj=new CAst::cast_expression_2(	$<_t_type_name>2,$<_t_cast_expression>4 ); LOG("Created cast_expression_2: "<<obj)$<_t_cast_expression>$=obj; LOG("Returning :"<<$<_t_cast_expression>$) 	}
	;
...
struct_declarator_list 
	: struct_declarator                                                                                    	{ LOG("struct_declarator_list:" <<"struct_declarator("<< $<_t_struct_declarator>1 <<")" <<")") CAst::struct_declarator_list_item *obj=new CAst::struct_declarator_list_item(	NULL,$<_t_struct_declarator>1 ); LOG("Created struct_declarator_list_item: "<<obj)CAst::struct_declarator_list *lst=new CAst::struct_declarator_list;lst->append(obj);$<_t_struct_declarator_list>$=lst; LOG("Created List struct_declarator_list: "<<lst)LOG("Returning :"<<$<_t_struct_declarator_list>$) 	}
	| struct_declarator_list ',' struct_declarator                                                         	{ LOG("struct_declarator_list:" <<"struct_declarator_list("<< $<_t_struct_declarator_list>1 <<")" <<"','("<< $<_t_string>2 <<")" <<"struct_declarator("<< $<_t_struct_declarator>3 <<")" <<")") CAst::struct_declarator_list_item *obj=new CAst::struct_declarator_list_item(	new CAst::token($<_t_string>2),$<_t_struct_declarator>3 ); LOG("Created struct_declarator_list_item: "<<obj)$<_t_struct_declarator_list>1 ->append(obj);$<_t_struct_declarator_list>$=$<_t_struct_declarator_list>1; LOG("Appended to struct_declarator_list") LOG("Returning :"<<$<_t_struct_declarator_list>$) 	}
	;



logical_or_expression 
	: logical_and_expression                                                                               	{ LOG("logical_or_expression:" <<"logical_and_expression("<< $<_t_logical_and_expression>1 <<")" <<")") CAst::logical_or_expression_item *obj=new CAst::logical_or_expression_item(	NULL,$<_t_logical_and_expression>1 ); LOG("Created logical_or_expression_item: "<<obj)CAst::logical_or_expression *lst=new CAst::logical_or_expression;lst->append(obj);$<_t_logical_or_expression>$=lst; LOG("Created List logical_or_expression: "<<lst)LOG("Returning :"<<$<_t_logical_or_expression>$) 	}
	| logical_or_expression OR_OP logical_and_expression                                                   	{ LOG("logical_or_expression:" <<"logical_or_expression("<< $<_t_logical_or_expression>1 <<")" <<"OR_OP("<< $<_t_string>2 <<")" <<"logical_and_expression("<< $<_t_logical_and_expression>3 <<")" <<")") CAst::logical_or_expression_item *obj=new CAst::logical_or_expression_item(	new CAst::token($<_t_string>2),$<_t_logical_and_expression>3 ); LOG("Created logical_or_expression_item: "<<obj)$<_t_logical_or_expression>1 ->append(obj);$<_t_logical_or_expression>$=$<_t_logical_or_expression>1; LOG("Appended to logical_or_expression") LOG("Returning :"<<$<_t_logical_or_expression>$) 	}
	;
...
assignment_expression 
	: conditional_expression                                                                               	{ LOG("assignment_expression:" <<"conditional_expression("<< $<_t_conditional_expression>1 <<")" <<")") CAst::assignment_expression_1 *obj=new CAst::assignment_expression_1(	$<_t_conditional_expression>1 ); LOG("Created assignment_expression_1: "<<obj)$<_t_assignment_expression>$=obj; LOG("Returning :"<<$<_t_assignment_expression>$) 	}
	| unary_expression assignment_operator assignment_expression                                           	{ LOG("assignment_expression:" <<"unary_expression("<< $<_t_unary_expression>1 <<")" <<"assignment_operator("<< $<_t_assignment_operator>2 <<")" <<"assignment_expression("<< $<_t_assignment_expression>3 <<")" <<")") CAst::assignment_expression_2 *obj=new CAst::assignment_expression_2(	$<_t_unary_expression>1,$<_t_assignment_operator>2,$<_t_assignment_expression>3 ); LOG("Created assignment_expression_2: "<<obj)$<_t_assignment_expression>$=obj; LOG("Returning :"<<$<_t_assignment_expression>$) 	}
	;
...
argument_expression_list 
	: assignment_expression                                                                                	{ LOG("argument_expression_list:" <<"assignment_expression("<< $<_t_assignment_expression>1 <<")" <<")") CAst::argument_expression_list_item *obj=new CAst::argument_expression_list_item(	NULL,$<_t_assignment_expression>1 ); LOG("Created argument_expression_list_item: "<<obj)CAst::argument_expression_list *lst=new CAst::argument_expression_list;lst->append(obj);$<_t_argument_expression_list>$=lst; LOG("Created List argument_expression_list: "<<lst)LOG("Returning :"<<$<_t_argument_expression_list>$) 	}
	| argument_expression_list ',' assignment_expression                                                   	{ LOG("argument_expression_list:" <<"argument_expression_list("<< $<_t_argument_expression_list>1 <<")" <<"','("<< $<_t_string>2 <<")" <<"assignment_expression("<< $<_t_assignment_expression>3 <<")" <<")") CAst::argument_expression_list_item *obj=new CAst::argument_expression_list_item(	new CAst::token($<_t_string>2),$<_t_assignment_expression>3 ); LOG("Created argument_expression_list_item: "<<obj)$<_t_argument_expression_list>1 ->append(obj);$<_t_argument_expression_list>$=$<_t_argument_expression_list>1; LOG("Appended to argument_expression_list") LOG("Returning :"<<$<_t_argument_expression_list>$) 	}
	;



direct_abstract_declarator 
	: '(' abstract_declarator ')'                                                                          	{ LOG("direct_abstract_declarator:" <<"'('("<< $<_t_string>1 <<")" <<"abstract_declarator("<< $<_t_abstract_declarator>2 <<")" <<"')'("<< $<_t_string>3 <<")" <<")") CAst::direct_abstract_declarator_3 *obj=new CAst::direct_abstract_declarator_3(	$<_t_abstract_declarator>2 ); LOG("Created direct_abstract_declarator_3: "<<obj)$<_t_direct_abstract_declarator>$=obj; LOG("Returning :"<<$<_t_direct_abstract_declarator>$) 	}
	...
	| '[' constant_expression ']'                                                                          	{ LOG("direct_abstract_declarator:" <<"'['("<< $<_t_string>1 <<")" <<"constant_expression("<< $<_t_constant_expression>2 <<")" <<"']'("<< $<_t_string>3 <<")" <<")") CAst::direct_abstract_declarator_1 *obj=new CAst::direct_abstract_declarator_1(	NULL,$<_t_constant_expression>2 ); LOG("Created direct_abstract_declarator_1: "<<obj)$<_t_direct_abstract_declarator>$=obj; LOG("Returning :"<<$<_t_direct_abstract_declarator>$) 	}
	...
	| direct_abstract_declarator '[' constant_expression ']'                                               	{ LOG("direct_abstract_declarator:" <<"direct_abstract_declarator("<< $<_t_direct_abstract_declarator>1 <<")" <<"'['("<< $<_t_string>2 <<")" <<"constant_expression("<< $<_t_constant_expression>3 <<")" <<"']'("<< $<_t_string>4 <<")" <<")") CAst::direct_abstract_declarator_1 *obj=new CAst::direct_abstract_declarator_1(	$<_t_direct_abstract_declarator>1,$<_t_constant_expression>3 ); LOG("Created direct_abstract_declarator_1: "<<obj)$<_t_direct_abstract_declarator>$=obj; LOG("Returning :"<<$<_t_direct_abstract_declarator>$) 	}
	| '(' ')'                                                                                              	{ LOG("direct_abstract_declarator:" <<"'('("<< $<_t_string>1 <<")" <<"')'("<< $<_t_string>2 <<")" <<")") CAst::direct_abstract_declarator_2 *obj=new CAst::direct_abstract_declarator_2(	NULL,NULL ); LOG("Created direct_abstract_declarator_2: "<<obj)$<_t_direct_abstract_declarator>$=obj; LOG("Returning :"<<$<_t_direct_abstract_declarator>$) 	}
	| '(' parameter_type_list ')'                                                                          	{ LOG("direct_abstract_declarator:" <<"'('("<< $<_t_string>1 <<")" <<"parameter_type_list("<< $<_t_parameter_type_list>2 <<")" <<"')'("<< $<_t_string>3 <<")" <<")") CAst::direct_abstract_declarator_2 *obj=new CAst::direct_abstract_declarator_2(	NULL,$<_t_parameter_type_list>2 ); LOG("Created direct_abstract_declarator_2: "<<obj)$<_t_direct_abstract_declarator>$=obj; LOG("Returning :"<<$<_t_direct_abstract_declarator>$) 	}
	| direct_abstract_declarator '(' ')'                                                                   	{ LOG("direct_abstract_declarator:" <<"direct_abstract_declarator("<< $<_t_direct_abstract_declarator>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"')'("<< $<_t_string>3 <<")" <<")") CAst::direct_abstract_declarator_2 *obj=new CAst::direct_abstract_declarator_2(	$<_t_direct_abstract_declarator>1,NULL ); LOG("Created direct_abstract_declarator_2: "<<obj)$<_t_direct_abstract_declarator>$=obj; LOG("Returning :"<<$<_t_direct_abstract_declarator>$) 	}
	| direct_abstract_declarator '(' parameter_type_list ')'                                               	{ LOG("direct_abstract_declarator:" <<"direct_abstract_declarator("<< $<_t_direct_abstract_declarator>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"parameter_type_list("<< $<_t_parameter_type_list>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<")") CAst::direct_abstract_declarator_2 *obj=new CAst::direct_abstract_declarator_2(	$<_t_direct_abstract_declarator>1,$<_t_parameter_type_list>3 ); LOG("Created direct_abstract_declarator_2: "<<obj)$<_t_direct_abstract_declarator>$=obj; LOG("Returning :"<<$<_t_direct_abstract_declarator>$) 	}
	;
...
primary_expression 
	: IDENTIFIER                                                                                           	{ LOG("primary_expression:" <<"IDENTIFIER("<< $<_t_string>1 <<")" <<")") CAst::primary_expression_2 *obj=new CAst::primary_expression_2(	new CAst::token($<_t_string>1) ); LOG("Created primary_expression_2: "<<obj)$<_t_primary_expression>$=obj; LOG("Returning :"<<$<_t_primary_expression>$) 	}
	| CONSTANT                                                                                             	{ LOG("primary_expression:" <<"CONSTANT("<< $<_t_string>1 <<")" <<")") CAst::primary_expression_2 *obj=new CAst::primary_expression_2(	new CAst::token($<_t_string>1) ); LOG("Created primary_expression_2: "<<obj)$<_t_primary_expression>$=obj; LOG("Returning :"<<$<_t_primary_expression>$) 	}
	| STRING_LITERAL                                                                                       	{ LOG("primary_expression:" <<"STRING_LITERAL("<< $<_t_string>1 <<")" <<")") CAst::primary_expression_2 *obj=new CAst::primary_expression_2(	new CAst::token($<_t_string>1) ); LOG("Created primary_expression_2: "<<obj)$<_t_primary_expression>$=obj; LOG("Returning :"<<$<_t_primary_expression>$) 	}
	| '(' expression ')'                                                                                   	{ LOG("primary_expression:" <<"'('("<< $<_t_string>1 <<")" <<"expression("<< $<_t_expression>2 <<")" <<"')'("<< $<_t_string>3 <<")" <<")") CAst::primary_expression_1 *obj=new CAst::primary_expression_1(	$<_t_expression>2 ); LOG("Created primary_expression_1: "<<obj)$<_t_primary_expression>$=obj; LOG("Returning :"<<$<_t_primary_expression>$) 	}
	;



declaration_specifiers 
	: storage_class_specifier                                                                              	{ LOG("declaration_specifiers:" <<"storage_class_specifier("<< $<_t_storage_class_specifier>1 <<")" <<")") CAst::declaration_specifiers_item_3 *obj=new CAst::declaration_specifiers_item_3(	$<_t_storage_class_specifier>1 ); LOG("Created declaration_specifiers_item_3: "<<obj)CAst::declaration_specifiers *lst=new CAst::declaration_specifiers;lst->append(obj);$<_t_declaration_specifiers>$=lst; LOG("Created List declaration_specifiers: "<<lst)LOG("Returning :"<<$<_t_declaration_specifiers>$) 	}
	| storage_class_specifier declaration_specifiers                                                       	{ LOG("declaration_specifiers:" <<"storage_class_specifier("<< $<_t_storage_class_specifier>1 <<")" <<"declaration_specifiers("<< $<_t_declaration_specifiers>2 <<")" <<")") CAst::declaration_specifiers_item_3 *obj=new CAst::declaration_specifiers_item_3(	$<_t_storage_class_specifier>1 ); LOG("Created declaration_specifiers_item_3: "<<obj)$<_t_declaration_specifiers>2 ->prepend(obj);$<_t_declaration_specifiers>$=$<_t_declaration_specifiers>2; LOG("Appended to declaration_specifiers") LOG("Returning :"<<$<_t_declaration_specifiers>$) 	}
	| type_specifier                                                                                       	{ LOG("declaration_specifiers:" <<"type_specifier("<< $<_t_type_specifier>1 <<")" <<")") CAst::declaration_specifiers_item_1 *obj=new CAst::declaration_specifiers_item_1(	$<_t_type_specifier>1 ); LOG("Created declaration_specifiers_item_1: "<<obj)CAst::declaration_specifiers *lst=new CAst::declaration_specifiers;lst->append(obj);$<_t_declaration_specifiers>$=lst; LOG("Created List declaration_specifiers: "<<lst)LOG("Returning :"<<$<_t_declaration_specifiers>$) 	}
	| type_specifier declaration_specifiers                                                                	{ LOG("declaration_specifiers:" <<"type_specifier("<< $<_t_type_specifier>1 <<")" <<"declaration_specifiers("<< $<_t_declaration_specifiers>2 <<")" <<")") CAst::declaration_specifiers_item_1 *obj=new CAst::declaration_specifiers_item_1(	$<_t_type_specifier>1 ); LOG("Created declaration_specifiers_item_1: "<<obj)$<_t_declaration_specifiers>2 ->prepend(obj);$<_t_declaration_specifiers>$=$<_t_declaration_specifiers>2; LOG("Appended to declaration_specifiers") LOG("Returning :"<<$<_t_declaration_specifiers>$) 	}
	| type_qualifier                                                                                       	{ LOG("declaration_specifiers:" <<"type_qualifier("<< $<_t_type_qualifier>1 <<")" <<")") CAst::declaration_specifiers_item_2 *obj=new CAst::declaration_specifiers_item_2(	$<_t_type_qualifier>1 ); LOG("Created declaration_specifiers_item_2: "<<obj)CAst::declaration_specifiers *lst=new CAst::declaration_specifiers;lst->append(obj);$<_t_declaration_specifiers>$=lst; LOG("Created List declaration_specifiers: "<<lst)LOG("Returning :"<<$<_t_declaration_specifiers>$) 	}
	| type_qualifier declaration_specifiers                                                                	{ LOG("declaration_specifiers:" <<"type_qualifier("<< $<_t_type_qualifier>1 <<")" <<"declaration_specifiers("<< $<_t_declaration_specifiers>2 <<")" <<")") CAst::declaration_specifiers_item_2 *obj=new CAst::declaration_specifiers_item_2(	$<_t_type_qualifier>1 ); LOG("Created declaration_specifiers_item_2: "<<obj)$<_t_declaration_specifiers>2 ->prepend(obj);$<_t_declaration_specifiers>$=$<_t_declaration_specifiers>2; LOG("Appended to declaration_specifiers") LOG("Returning :"<<$<_t_declaration_specifiers>$) 	}
	;
...
direct_declarator 
	: IDENTIFIER                                                                                           	{ LOG("direct_declarator:" <<"IDENTIFIER("<< $<_t_string>1 <<")" <<")") CAst::direct_declarator_1 *obj=new CAst::direct_declarator_1(	new CAst::token($<_t_string>1) ); LOG("Created direct_declarator_1: "<<obj)$<_t_direct_declarator>$=obj; LOG("Returning :"<<$<_t_direct_declarator>$) 	}
	| '(' declarator ')'                                                                                   	{ LOG("direct_declarator:" <<"'('("<< $<_t_string>1 <<")" <<"declarator("<< $<_t_declarator>2 <<")" <<"')'("<< $<_t_string>3 <<")" <<")") CAst::direct_declarator_3 *obj=new CAst::direct_declarator_3(	$<_t_declarator>2 ); LOG("Created direct_declarator_3: "<<obj)$<_t_direct_declarator>$=obj; LOG("Returning :"<<$<_t_direct_declarator>$) 	}
	| direct_declarator '[' constant_expression ']'                                                        	{ LOG("direct_declarator:" <<"direct_declarator("<< $<_t_direct_declarator>1 <<")" <<"'['("<< $<_t_string>2 <<")" <<"constant_expression("<< $<_t_constant_expression>3 <<")" <<"']'("<< $<_t_string>4 <<")" <<")") CAst::direct_declarator_4 *obj=new CAst::direct_declarator_4(	$<_t_direct_declarator>1,$<_t_constant_expression>3 ); LOG("Created direct_declarator_4: "<<obj)$<_t_direct_declarator>$=obj; LOG("Returning :"<<$<_t_direct_declarator>$) 	}
	| direct_declarator '[' ']'                                                                            	{ LOG("direct_declarator:" <<"direct_declarator("<< $<_t_direct_declarator>1 <<")" <<"'['("<< $<_t_string>2 <<")" <<"']'("<< $<_t_string>3 <<")" <<")") CAst::direct_declarator_4 *obj=new CAst::direct_declarator_4(	$<_t_direct_declarator>1,NULL ); LOG("Created direct_declarator_4: "<<obj)$<_t_direct_declarator>$=obj; LOG("Returning :"<<$<_t_direct_declarator>$) 	}
	| direct_declarator '(' parameter_type_list ')'                                                        	{ LOG("direct_declarator:" <<"direct_declarator("<< $<_t_direct_declarator>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"parameter_type_list("<< $<_t_parameter_type_list>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<")") CAst::direct_declarator_5 *obj=new CAst::direct_declarator_5(	$<_t_direct_declarator>1,$<_t_parameter_type_list>3 ); LOG("Created direct_declarator_5: "<<obj)$<_t_direct_declarator>$=obj; LOG("Returning :"<<$<_t_direct_declarator>$) 	}
	...
	| direct_declarator '(' ')'                                                                            	{ LOG("direct_declarator:" <<"direct_declarator("<< $<_t_direct_declarator>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"')'("<< $<_t_string>3 <<")" <<")") CAst::direct_declarator_5 *obj=new CAst::direct_declarator_5(	$<_t_direct_declarator>1,NULL ); LOG("Created direct_declarator_5: "<<obj)$<_t_direct_declarator>$=obj; LOG("Returning :"<<$<_t_direct_declarator>$) 	}
	;



logical_and_expression 
	: inclusive_or_expression                                                                              	{ LOG("logical_and_expression:" <<"inclusive_or_expression("<< $<_t_inclusive_or_expression>1 <<")" <<")") CAst::logical_and_expression_item *obj=new CAst::logical_and_expression_item(	NULL,$<_t_inclusive_or_expression>1 ); LOG("Created logical_and_expression_item: "<<obj)CAst::logical_and_expression *lst=new CAst::logical_and_expression;lst->append(obj);$<_t_logical_and_expression>$=lst; LOG("Created List logical_and_expression: "<<lst)LOG("Returning :"<<$<_t_logical_and_expression>$) 	}
	| logical_and_expression AND_OP inclusive_or_expression                                                	{ LOG("logical_and_expression:" <<"logical_and_expression("<< $<_t_logical_and_expression>1 <<")" <<"AND_OP("<< $<_t_string>2 <<")" <<"inclusive_or_expression("<< $<_t_inclusive_or_expression>3 <<")" <<")") CAst::logical_and_expression_item *obj=new CAst::logical_and_expression_item(	new CAst::token($<_t_string>2),$<_t_inclusive_or_expression>3 ); LOG("Created logical_and_expression_item: "<<obj)$<_t_logical_and_expression>1 ->append(obj);$<_t_logical_and_expression>$=$<_t_logical_and_expression>1; LOG("Appended to logical_and_expression") LOG("Returning :"<<$<_t_logical_and_expression>$) 	}
	;



init_declarator_list 
	: init_declarator                                                                                      	{ LOG("init_declarator_list:" <<"init_declarator("<< $<_t_init_declarator>1 <<")" <<")") CAst::init_declarator_list_item *obj=new CAst::init_declarator_list_item(	NULL,$<_t_init_declarator>1 ); LOG("Created init_declarator_list_item: "<<obj)CAst::init_declarator_list *lst=new CAst::init_declarator_list;lst->append(obj);$<_t_init_declarator_list>$=lst; LOG("Created List init_declarator_list: "<<lst)LOG("Returning :"<<$<_t_init_declarator_list>$) 	}
	| init_declarator_list ',' init_declarator                                                             	{ LOG("init_declarator_list:" <<"init_declarator_list("<< $<_t_init_declarator_list>1 <<")" <<"','("<< $<_t_string>2 <<")" <<"init_declarator("<< $<_t_init_declarator>3 <<")" <<")") CAst::init_declarator_list_item *obj=new CAst::init_declarator_list_item(	new CAst::token($<_t_string>2),$<_t_init_declarator>3 ); LOG("Created init_declarator_list_item: "<<obj)$<_t_init_declarator_list>1 ->append(obj);$<_t_init_declarator_list>$=$<_t_init_declarator_list>1; LOG("Appended to init_declarator_list") LOG("Returning :"<<$<_t_init_declarator_list>$) 	}
	;
...
identifier_list 
	: IDENTIFIER                                                                                           	{ LOG("identifier_list:" <<"IDENTIFIER("<< $<_t_string>1 <<")" <<")") CAst::identifier_list_item *obj=new CAst::identifier_list_item(	NULL,new CAst::token($<_t_string>1) ); LOG("Created identifier_list_item: "<<obj)CAst::identifier_list *lst=new CAst::identifier_list;lst->append(obj);$<_t_identifier_list>$=lst; LOG("Created List identifier_list: "<<lst)LOG("Returning :"<<$<_t_identifier_list>$) 	}
	| identifier_list ',' IDENTIFIER                                                                       	{ LOG("identifier_list:" <<"identifier_list("<< $<_t_identifier_list>1 <<")" <<"','("<< $<_t_string>2 <<")" <<"IDENTIFIER("<< $<_t_string>3 <<")" <<")") CAst::identifier_list_item *obj=new CAst::identifier_list_item(	new CAst::token($<_t_string>2),new CAst::token($<_t_string>3) ); LOG("Created identifier_list_item: "<<obj)$<_t_identifier_list>1 ->append(obj);$<_t_identifier_list>$=$<_t_identifier_list>1; LOG("Appended to identifier_list") LOG("Returning :"<<$<_t_identifier_list>$) 	}
	;
...
jump_statement 
	...
	| CONTINUE ';'                                                                                         	{ LOG("jump_statement:" <<"CONTINUE("<< $<_t_string>1 <<")" <<"';'("<< $<_t_string>2 <<")" <<")") CAst::jump_statement_2 *obj=new CAst::jump_statement_2(	new CAst::token($<_t_string>1) ); LOG("Created jump_statement_2: "<<obj)$<_t_jump_statement>$=obj; LOG("Returning :"<<$<_t_jump_statement>$) 	}
	| BREAK ';'                                                                                            	{ LOG("jump_statement:" <<"BREAK("<< $<_t_string>1 <<")" <<"';'("<< $<_t_string>2 <<")" <<")") CAst::jump_statement_2 *obj=new CAst::jump_statement_2(	new CAst::token($<_t_string>1) ); LOG("Created jump_statement_2: "<<obj)$<_t_jump_statement>$=obj; LOG("Returning :"<<$<_t_jump_statement>$) 	}
	| RETURN ';'                                                                                           	{ LOG("jump_statement:" <<"RETURN("<< $<_t_string>1 <<")" <<"';'("<< $<_t_string>2 <<")" <<")") CAst::jump_statement_3 *obj=new CAst::jump_statement_3(	NULL ); LOG("Created jump_statement_3: "<<obj)$<_t_jump_statement>$=obj; LOG("Returning :"<<$<_t_jump_statement>$) 	}
	| RETURN expression ';'                                                                                	{ LOG("jump_statement:" <<"RETURN("<< $<_t_string>1 <<")" <<"expression("<< $<_t_expression>2 <<")" <<"';'("<< $<_t_string>3 <<")" <<")") CAst::jump_statement_3 *obj=new CAst::jump_statement_3(	$<_t_expression>2 ); LOG("Created jump_statement_3: "<<obj)$<_t_jump_statement>$=obj; LOG("Returning :"<<$<_t_jump_statement>$) 	}
	;
...
parameter_list 
	: parameter_declaration                                                                                	{ LOG("parameter_list:" <<"parameter_declaration("<< $<_t_parameter_declaration>1 <<")" <<")") CAst::parameter_list_item *obj=new CAst::parameter_list_item(	NULL,$<_t_parameter_declaration>1 ); LOG("Created parameter_list_item: "<<obj)CAst::parameter_list *lst=new CAst::parameter_list;lst->append(obj);$<_t_parameter_list>$=lst; LOG("Created List parameter_list: "<<lst)LOG("Returning :"<<$<_t_parameter_list>$) 	}
	| parameter_list ',' parameter_declaration                                                             	{ LOG("parameter_list:" <<"parameter_list("<< $<_t_parameter_list>1 <<")" <<"','("<< $<_t_string>2 <<")" <<"parameter_declaration("<< $<_t_parameter_declaration>3 <<")" <<")") CAst::parameter_list_item *obj=new CAst::parameter_list_item(	new CAst::token($<_t_string>2),$<_t_parameter_declaration>3 ); LOG("Created parameter_list_item: "<<obj)$<_t_parameter_list>1 ->append(obj);$<_t_parameter_list>$=$<_t_parameter_list>1; LOG("Appended to parameter_list") LOG("Returning :"<<$<_t_parameter_list>$) 	}
	;
...
enumerator_list 
	: enumerator                                                                                           	{ LOG("enumerator_list:" <<"enumerator("<< $<_t_enumerator>1 <<")" <<")") CAst::enumerator_list_item *obj=new CAst::enumerator_list_item(	NULL,$<_t_enumerator>1 ); LOG("Created enumerator_list_item: "<<obj)CAst::enumerator_list *lst=new CAst::enumerator_list;lst->append(obj);$<_t_enumerator_list>$=lst; LOG("Created List enumerator_list: "<<lst)LOG("Returning :"<<$<_t_enumerator_list>$) 	}
	| enumerator_list ',' enumerator                                                                       	{ LOG("enumerator_list:" <<"enumerator_list("<< $<_t_enumerator_list>1 <<")" <<"','("<< $<_t_string>2 <<")" <<"enumerator("<< $<_t_enumerator>3 <<")" <<")") CAst::enumerator_list_item *obj=new CAst::enumerator_list_item(	new CAst::token($<_t_string>2),$<_t_enumerator>3 ); LOG("Created enumerator_list_item: "<<obj)$<_t_enumerator_list>1 ->append(obj);$<_t_enumerator_list>$=$<_t_enumerator_list>1; LOG("Appended to enumerator_list") LOG("Returning :"<<$<_t_enumerator_list>$) 	}
	;



labeled_statement 
	: IDENTIFIER ':' statement                                                                             	{ LOG("labeled_statement:" <<"IDENTIFIER("<< $<_t_string>1 <<")" <<"':'("<< $<_t_string>2 <<")" <<"statement("<< $<_t_statement>3 <<")" <<")") CAst::labeled_statement_1 *obj=new CAst::labeled_statement_1(	new CAst::token($<_t_string>1),$<_t_statement>3 ); LOG("Created labeled_statement_1: "<<obj)$<_t_labeled_statement>$=obj; LOG("Returning :"<<$<_t_labeled_statement>$) 	}
	| CASE constant_expression ':' statement                                                               	{ LOG("labeled_statement:" <<"CASE("<< $<_t_string>1 <<")" <<"constant_expression("<< $<_t_constant_expression>2 <<")" <<"':'("<< $<_t_string>3 <<")" <<"statement("<< $<_t_statement>4 <<")" <<")") CAst::labeled_statement_2 *obj=new CAst::labeled_statement_2(	$<_t_constant_expression>2,$<_t_statement>4 ); LOG("Created labeled_statement_2: "<<obj)$<_t_labeled_statement>$=obj; LOG("Returning :"<<$<_t_labeled_statement>$) 	}
	| DEFAULT ':' statement                                                                                	{ LOG("labeled_statement:" <<"DEFAULT("<< $<_t_string>1 <<")" <<"':'("<< $<_t_string>2 <<")" <<"statement("<< $<_t_statement>3 <<")" <<")") CAst::labeled_statement_1 *obj=new CAst::labeled_statement_1(	new CAst::token($<_t_string>1),$<_t_statement>3 ); LOG("Created labeled_statement_1: "<<obj)$<_t_labeled_statement>$=obj; LOG("Returning :"<<$<_t_labeled_statement>$) 	}
	;
...
initializer_list 
	: initializer                                                                                          	{ LOG("initializer_list:" <<"initializer("<< $<_t_initializer>1 <<")" <<")") CAst::initializer_list_item *obj=new CAst::initializer_list_item(	NULL,$<_t_initializer>1 ); LOG("Created initializer_list_item: "<<obj)CAst::initializer_list *lst=new CAst::initializer_list;lst->append(obj);$<_t_initializer_list>$=lst; LOG("Created List initializer_list: "<<lst)LOG("Returning :"<<$<_t_initializer_list>$) 	}
	| initializer_list ',' initializer                                                                     	{ LOG("initializer_list:" <<"initializer_list("<< $<_t_initializer_list>1 <<")" <<"','("<< $<_t_string>2 <<")" <<"initializer("<< $<_t_initializer>3 <<")" <<")") CAst::initializer_list_item *obj=new CAst::initializer_list_item(	new CAst::token($<_t_string>2),$<_t_initializer>3 ); LOG("Created initializer_list_item: "<<obj)$<_t_initializer_list>1 ->append(obj);$<_t_initializer_list>$=$<_t_initializer_list>1; LOG("Appended to initializer_list") LOG("Returning :"<<$<_t_initializer_list>$) 	}
	;
