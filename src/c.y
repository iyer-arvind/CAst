...
pointer 
	...
	| '*' pointer                                                                                          	{ LOG("pointer:" <<"'*'("<< $<_t_string>1 <<")" <<"pointer("<< $<_t_pointer>2 <<")" <<")") CAst::pointer_item_1 *obj=new CAst::pointer_item_1(	 ); LOG("Created pointer_item_1: "<<obj)$<_t_pointer>2 ->prepend(obj);$<_t_pointer>$=$<_t_pointer>2; LOG("Appended to pointer") LOG("Returning :"<<$<_t_pointer>$) 	}
...
postfix_expression 
	: primary_expression                                                                                   	{ LOG("postfix_expression:" <<"primary_expression("<< $<_t_primary_expression>1 <<")" <<")") CAst::postfix_expression_3 *obj=new CAst::postfix_expression_3(	$<_t_primary_expression>1 ); LOG("Created postfix_expression_3: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression '[' expression ']'                                                                	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"'['("<< $<_t_string>2 <<")" <<"expression("<< $<_t_expression>3 <<")" <<"']'("<< $<_t_string>4 <<")" <<")") CAst::postfix_expression_5 *obj=new CAst::postfix_expression_5(	$<_t_postfix_expression>1,$<_t_expression>3 ); LOG("Created postfix_expression_5: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression '(' ')'                                                                           	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"')'("<< $<_t_string>3 <<")" <<")") CAst::postfix_expression_1 *obj=new CAst::postfix_expression_1(	$<_t_postfix_expression>1,NULL ); LOG("Created postfix_expression_1: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression '(' argument_expression_list ')'                                                  	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"'('("<< $<_t_string>2 <<")" <<"argument_expression_list("<< $<_t_argument_expression_list>3 <<")" <<"')'("<< $<_t_string>4 <<")" <<")") CAst::postfix_expression_1 *obj=new CAst::postfix_expression_1(	$<_t_postfix_expression>1,$<_t_argument_expression_list>3 ); LOG("Created postfix_expression_1: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	...
	| postfix_expression INC_OP                                                                            	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"INC_OP("<< $<_t_string>2 <<")" <<")") CAst::postfix_expression_4 *obj=new CAst::postfix_expression_4(	$<_t_postfix_expression>1,new CAst::token($<_t_string>2) ); LOG("Created postfix_expression_4: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	| postfix_expression DEC_OP                                                                            	{ LOG("postfix_expression:" <<"postfix_expression("<< $<_t_postfix_expression>1 <<")" <<"DEC_OP("<< $<_t_string>2 <<")" <<")") CAst::postfix_expression_4 *obj=new CAst::postfix_expression_4(	$<_t_postfix_expression>1,new CAst::token($<_t_string>2) ); LOG("Created postfix_expression_4: "<<obj)$<_t_postfix_expression>$=obj; LOG("Returning :"<<$<_t_postfix_expression>$) 	}
	;
...
declaration_specifiers 
	...
	| storage_class_specifier declaration_specifiers                                                       	{ LOG("declaration_specifiers:" <<"storage_class_specifier("<< $<_t_storage_class_specifier>1 <<")" <<"declaration_specifiers("<< $<_t_declaration_specifiers>2 <<")" <<")") CAst::declaration_specifiers_item_1 *obj=new CAst::declaration_specifiers_item_1(	$<_t_storage_class_specifier>1 ); LOG("Created declaration_specifiers_item_1: "<<obj)$<_t_declaration_specifiers>2 ->prepend(obj);$<_t_declaration_specifiers>$=$<_t_declaration_specifiers>2; LOG("Appended to declaration_specifiers") LOG("Returning :"<<$<_t_declaration_specifiers>$) 	}
	...
	| type_qualifier declaration_specifiers                                                                	{ LOG("declaration_specifiers:" <<"type_qualifier("<< $<_t_type_qualifier>1 <<")" <<"declaration_specifiers("<< $<_t_declaration_specifiers>2 <<")" <<")") CAst::declaration_specifiers_item_3 *obj=new CAst::declaration_specifiers_item_3(	$<_t_type_qualifier>1 ); LOG("Created declaration_specifiers_item_3: "<<obj)$<_t_declaration_specifiers>2 ->prepend(obj);$<_t_declaration_specifiers>$=$<_t_declaration_specifiers>2; LOG("Appended to declaration_specifiers") LOG("Returning :"<<$<_t_declaration_specifiers>$) 	}
	;
